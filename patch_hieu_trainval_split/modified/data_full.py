...
def visibility_records_for_manifest(
    ...
    The full snapshot has segmentation labels for 524 frames but visibility
    labels for only 308. Missing visibility annotations are excluded rather
    than being silently interpreted as all-negative targets.
    """
    root = Path(data_root)
