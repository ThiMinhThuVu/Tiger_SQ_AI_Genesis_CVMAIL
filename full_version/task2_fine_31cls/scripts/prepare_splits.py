#!/usr/bin/env python3
"""Audit the full dataset and write the immutable seed-2026 case manifest."""
...
from full_version.task2_fine_31cls.scripts.data_full import audit_fine_masks, build_manifest
...
def main() -> None:
    ...
    manifest = build_manifest(args.data_root, args.split_seed)
